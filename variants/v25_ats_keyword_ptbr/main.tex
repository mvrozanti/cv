...
\item \textbf{Bancos de dados}: PostgreSQL, MongoDB, MySQL, Oracle SQL Server, Microsoft SQL Server, Redis
\item \textbf{Cloud \& DevOps}: AWS (SQS, SNS, S3, EC2, Lambda), Docker, Terraform, Harness, GitLab CI/CD, Travis CI, Maven, Ant
...
\item \textbf{Domínios}: Bancário, pagamentos, Pix, POS / presencial, decisão de crédito, automação fiscal, LGPD
\end{itemize}

\section{Experiência profissional}

\noindent\textbf{C6 Bank} -- Engenheiro de Software Sênior \hfill Abril 2025 -- Atual\\
São Paulo, Brasil
\begin{itemize}
