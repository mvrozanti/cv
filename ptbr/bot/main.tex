...
\item \textbf{Metodologias}: Domain-Driven Design (DDD), Event Sourcing, Test-Driven Development (TDD), DevSecOps, CI/CD, Agile, DTAP
...
\noindent\textbf{Upwork} -- Desenvolvedor Backend (Freelance) \hfill Outubro 2022 -- Janeiro 2024\\
Remoto
\begin{itemize}
